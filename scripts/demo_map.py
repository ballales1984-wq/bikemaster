...
def generate_first_map():
    points = generate_sample_ride(n_points=50, center_lat=45.4654, center_lon=9.1859, radius_km=5.0, duration_minutes=45)
    ...
    print(f"Statistiche: distanza={stats.total_distance_m/1000:.2f}km, velocità media={stats.avg_speed_km_h:.1f}km/h, pausa={stats.pause_count}")
    return output_path
