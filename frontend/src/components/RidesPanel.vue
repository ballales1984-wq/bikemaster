  ...
  <section class="rides-section">
    ...
    <div class="panel add-panel">
      ...
      <transition name="slide-down">
        <form v-if="showForm"
@submit.prevent="handleAdd" class="ride-form">
          <div class="form-grid">
...
class="empty-state">
      ...
      <!-- Filtered empty -->
      <div v-else-if="filteredRides.length === 0"
class="empty-state">
        <div class="empty-icon">🔍</div>
        <div class="empty-title">
          {{ t("common.none") }}
...
class="analysis-section">
            ...
            <div class="analysis-grid">
              <div v-if="analysis.fatigue_score" class="a-stat">
