...
describe('GranfondoPlanner', () => {
  ...
  it('generates plan when button clicked', async () => {
    ...
    expect(apiPost).toHaveBeenCalledWith('/api/v1/training/granfondo/plan', expect.objectContaining({
      athlete_id: 1,
  ...
  it('has week days array', async () => {
    ...
    expect(wrapper.vm.weekDays).toEqual(['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'])
  })
