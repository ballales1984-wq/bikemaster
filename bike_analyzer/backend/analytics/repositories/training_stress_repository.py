...
class TrainingStressRepository:
    ...
    @staticmethod
    def upsert_training_stress_day(athlete_id, date, tss, atl, ctl, tsb, tenant_id=0):
        return TrainingStressRepository()._upsert_sync(athlete_id, date, tss, atl, ctl, tsb, tenant_id)

    @staticmethod
    def get_training_stress_days(athlete_id, limit=90, tenant_id=None):
        return TrainingStressRepository()._get_history_sync(athlete_id, limit, tenant_id)

    @staticmethod
    def get_latest_training_stress(athlete_id, tenant_id=None):
        return TrainingStressRepository()._get_latest_sync(athlete_id, tenant_id)
