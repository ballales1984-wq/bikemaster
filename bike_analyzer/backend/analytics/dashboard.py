...
def get_score_breakdown(ride: Ride) -> dict[str, float]:
    return {
        "performance": calculate_performance_score(ride),
        "recovery": calculate_recovery_score(ride),
        "efficiency": calculate_efficiency_score(ride),
    }
