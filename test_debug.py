...
cur = conn.cursor()
cur.execute(
    "INSERT INTO rides (athlete_id, tenant_id, date, distance_km, duration_minutes, weight_kg, calories, gps_points, activity_type, is_official, source, created_at) VALUES (0, 0, ?, 25.0, 60.0, 70, 0, ?, ?, 1, ?, datetime('now'))",
